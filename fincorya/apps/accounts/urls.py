...
urlpatterns = [
    ...
    path("utilisateurs/<int:pk>/renvoyer-invitation/", management_views.account_resend_invitation, name="manage_resend_invitation"),
    path("activer/<int:user_id>/<str:token>/", views.activate_account, name="activate"),
